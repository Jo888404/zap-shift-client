...
// import RiderService from "../pages/Home/Services/RiderService";
// import MyOrders from "../pages/Home/Services/MyOrders";
...
//   {
//     path: "/dashboard",
//     element: <AdminRoute><PrivateRoute><DashboardLayouts></DashboardLayouts></PrivateRoute></AdminRoute>,
//     children: [
//       {
//         path: 'myParcels',
//         Component: MyParcels
...
export const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      { path: "pending-riders", Component: PendingRiders },
      { path: "hires", Component: AdminHireList },
    ],
  },
]);
